...
<script src="{{asset('/admin')}}/js/material-dashboard.min1036.js?v=2.1.1" type="text/javascript"></script>
...
<script>
    $(document).ready(function() {
        ...
        ! function(f, b, e, v, n, t, s) {
            ...
            document, 'script', '{{asset('/admin')}}/connect.facebook.net/en_US/fbevents.js');
...
<script>
    (function(w, d, s, l, i) {
        ...
        j.async = true;
        j.src =
            '{{asset('/admin')}}/www.googletagmanager.com/gtm5445.html?id=' + i + dl;
