                    ...
                    <div class="col-md-7 new-grid">
                        ...
                        <div class="color-quality">
                            <div class="color-quality-left">
                                <h6>Color : </h6>
                                <ul>
                                    <li><a href="{{asset('/front')}}/#"><span></span>Red</a></li>
                                    <li><a href="{{asset('/front')}}/#" class="brown"><span></span>Yellow</a></li>
                                    <li><a href="{{asset('/front')}}/#" class="purple"><span></span>Purple</a></li>
                                    <li><a href="{{asset('/front')}}/#" class="gray"><span></span>Violet</a></li>
                                </ul>
                            </div>
